...
WebUI.click(findTestObject('Orange/Configuration/BTN_Edit'))

WebUI.selectOptionByLabel(findTestObject('Orange/Configuration/Language'), 'English', false)

WebUI.click(findTestObject('Orange/Configuration/BTN_Save'))
